REGISTER '/home/acadgild/pig-0.14.0/lib/piggybank.jar'                      //Registering the jar to load xml file.

REGISTER '/home/acadgild/CheckBPL.jar'                                    //Registering the Udf for checking the states who have reached 80% of objective of BPL card.
...
exporting to mysql   //exporting the  above scripts result into mysql table.
...
C = foreach xml_row generate district,objBPL,perfBPL;
D = foreach C generate district,objBPL,perfBPL,CHECK_BPL(objBPL,perfBPL) as check;      //applying UDF
